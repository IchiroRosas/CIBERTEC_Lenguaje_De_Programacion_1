...
<body>
	...
	<div class="text-center text-decoration-underline">
		<h1 class="fw-bold">Filtro de Empleados</h1>
	</div>
	<br>
	<form action="WorkServlet">
		...
		<div class="row g-3 justify-content-end tamaño">
			<div class="col-auto">
				<label class="col-form-label fw-bold">Tipo de Contrato: </label>
			</div>
			<div class="col-auto">
				<select class="form-control border border-black" name = "cboTipo">
					<option value="Determinado" disable selected hidden>--Selecciona una Opción--</option>
					<option value = "Determinado" >Determinado</option>
					<option value = "Indeterminado" > Indeterminado</option>
					<option value = "A Tiempo Parcial" >Tiempo Parcial</option>
				</select>
			</div>
			<div class="col-auto">
	...
	<div class="tamaño">
		<table class="table">
			...
			<tbody>
				<c:forEach items="${dataFiltrada}" var="p">
					<tr>
						<td>${p.idWorkers}</td>
						<td>${p.nombres}</td>
						<td>${p.apellidoP}</td>
						...
						<td>${p.direccion}</td>
						<td>
							<button type="button" class="btn btn-info btn-lg" data-bs-toggle="modal" data-bs-target="#exampleModal" onclick="cargarInfo(${p.idWorkers})">Info</button>
						</td>
					</tr>
				</c:forEach>
			</tbody>
								...
								<div class="justify-content-center">
										...
										<div class="row">
											<div class="col-md-4">
												<div class="form-group d-flex align-items-center">
													<label for="inputNombres" class="col-form-label">Nombres Completos:</label>
													<input type="text" id="inputNombres" class="form-control" value="">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group d-flex align-items-center">
													<label for="inputApellidoP" class="col-form-label">Apellido Paterno:</label>
													<input type="text" id="inputApellidoP" class="form-control" value="">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group d-flex align-items-center">
													<label for="inputApellidoM" class="col-form-label">Apellido Materno:</label>
													<input type="text" id="inputApellidoM" class="form-control" value="">
												</div>
											</div>
										</div>
									</div>
										...
										<div class="row">
											<div class="col-md-4">
												<div class="form-group d-flex align-items-center">
													...
													<input type="text" id="inputDni" class="form-control" value="">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group d-flex align-items-center">
													<label for="inputDireccion" class="col-form-label">Direccion:</label>
													<input type="text" id="inputDireccion" class="form-control" value="">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group d-flex align-items-center">
													<label for="inputTelefono" class="col-form-label">Telefono:</label>
													<input type="text" id="inputTelefono" class="form-control" value="">
												</div>
											</div>
										</div>
									</div>
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="date" id="inputNacimiento" class="form-control" value="">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label for="inputCorreo" class="col-form-label">Correo:</label>
													<input type="email" id="inputCorreo" class="form-control" value="">
												</div>
											</div>
										</div>
									</div>
										...
										<div class="row">
											<div class="col-md-4">
												<div class="form-group d-flex align-items-center">
													...
													<input type="text" id="inputSalario" class="form-control" aria-describedby="passwordHelpInline">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group d-flex align-items-center">
													<label for="inputJornada" class="col-form-label">Jornada Diaria:</label>
													<input type="text" id="inputJornada" class="form-control" aria-describedby="passwordHelpInline">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group d-flex align-items-center">
													<label for="inputCargo" class="col-form-label">Cargo:</label>											
													<input type="text" id="inputCargo" class="form-control" aria-describedby="passwordHelpInline">
												</div>
											</div>
										</div>
									</div>
									...
									<div class="d-flex justify-content-center">
										<div class="row">
											<div class="col-md-4">
												<div class="form-group d-flex align-items-center">
													<label for="inputInicioContrato" class="col-form-label">Inicio del Contrato:</label>
													<input type="date" id="inputInicioContrato" class="form-control" aria-describedby="passwordHelpInline">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group d-flex align-items-center">
													<label for="inputFinContrato" class="col-form-label">Fin del Contrato:</label>
													<input type="date" id="inputFinContrato" class="form-control" aria-describedby="passwordHelpInline">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group d-flex align-items-center">
													<label for="inputTipoContrato" class="col-form-label">Tipo Contrato:</label>
													<input type="text" id="inputTipoContrato" class="form-control" aria-describedby="passwordHelpInline">
												</div>
											</div>
										</div>
									</div>
...
function cargarInfo(idEmpleado) {
    $.ajax({
        ...
        success: function(response) {
            // Actualizar los valores de los inputs del modal con la información del empleado

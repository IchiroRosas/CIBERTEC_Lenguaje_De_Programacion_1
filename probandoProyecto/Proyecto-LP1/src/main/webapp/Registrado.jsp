...
<body>
	...
	<form action="WorkServlet" method="post" name = "FormularioRegistro">
		...
		<div class="text-center text-decoration-underline">
			<h1>Registro de Empleados Nuevos</h1>
		</div>
		<br>
		<div class="d-flex justify-content-center">
			<div class="row g-3 align-items-center">
				...
				<div class="col-auto fs-3 input-group-lg">
					<input type="text" name = "txtNombres" class="form-control border border-black" aria-describedby="passwordHelpInline">
				...
				<div class="col-auto fs-3 input-group-lg">
					<input type="text" name = "txtApellidoP" class="form-control border border-black" aria-describedby="passwordHelpInline">
					 <div class="error-message"></div>
				</div>
				<div class="col-auto fs-3">
					<label class="col-form-label">Apellido
				...
				<div class="col-auto fs-3 input-group-lg">
					<input type="text" name = "txtApellidoM" class="form-control border border-black" aria-describedby="passwordHelpInline">
					 <div class="error-message"></div>
				</div>
			</div>
		</div>
		...
		<div class="d-flex justify-content-center">
			<div class="row g-3 align-items-center">
				...
				<div class="col-auto fs-3 input-group-lg">
					<input type="text" name = "txtDni" class="form-control border border-black" aria-describedby="passwordHelpInline">
					 <div class="error-message"></div>
				</div>
				<div class="col-auto fs-3">
				...
				<div class="col-auto fs-3 input-group-lg">
					<input type="text" name = "txtDireccion" class="form-control border border-black" aria-describedby="passwordHelpInline">
					 <div class="error-message"></div>
				</div>
				<div class="col-auto fs-3">
				...
				<div class="col-auto fs-3 input-group-lg">
					<input type="text" name = "txtTelefono" class="form-control border border-black" aria-describedby="passwordHelpInline">
					 <div class="error-message"></div>
				</div>
			</div>
		</div>
		...
		<div class="d-flex justify-content-center">
			<div class="row g-3 align-items-center">
				...
				<div class="col-auto fs-3 input-group-lg">
					<input type="date" name = "txtNacimiento" class="form-control border border-black" aria-describedby="passwordHelpInline">
					 <div class="error-message"></div>
				</div>
				<div class="col-auto fs-3">
				...
				<div class="col-auto fs-3 input-group-lg">
					<input type="email" name = "txtCorreo" class="form-control border border-black" aria-describedby="passwordHelpInline">
					 <div class="error-message"></div>
				</div>
			</div>
		</div>
		...
		<div class="d-flex justify-content-center">
			<div class="row g-3 align-items-center">
				...
				<div class="col-auto fs-3 input-group-lg">
					<input type="text" name = "txtSalario" class="form-control border border-black" aria-describedby="passwordHelpInline">
					 <div class="error-message"></div>
				</div>
				<div class="col-auto fs-3">
					<label class="col-form-label">Jornada Diaria : </label>
				</div>
				<div class="col-auto fs-3 input-group-lg">
					<input type="text" name = "txtJornada" class="form-control border border-black" aria-describedby="passwordHelpInline">
					 <div class="error-message"></div>
				</div>
				<div class="col-auto fs-3">
				...
				<div class="col-auto fs-3 input-group-lg">
					<select class="form-control border border-black" name = "txtCargo">
						<option value="Trabajador" disable selected hidden>--Selecciona una Opción--</option>
		...
		<div class="d-flex justify-content-center">
			<div class="row g-3 align-items-center">
				...
				<div class="col-auto fs-3 input-group-lg">
					<input type="date" name = "txtInicioContrato" class="form-control border border-black" aria-describedby="passwordHelpInline">
					 <div class="error-message"></div>
				</div>
				<div class="col-auto fs-3">
				...
				<div class="col-auto fs-3 input-group-lg">
					<input type="date"  name = "txtFinContrato" class="form-control border border-black" aria-describedby="passwordHelpInline">
					 <div class="error-message"></div>
				</div>
				<div class="col-auto fs-3">
		...
		<div class="text-center">
			<input type="submit" class="btn btn-primary btn-lg" value="Enviar Datos">
			<button type="reset" class="btn btn-danger btn-lg">Borrar  Datos</button>
		</div>
	</form>
</body>
<script
  ...
  $(function(){
    $("form[name='FormularioRegistro']").validate({
      ...
      messages: {
          ...
          txtDireccion: "Por favor ingresa tu dirección",

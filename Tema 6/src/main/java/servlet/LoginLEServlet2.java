...
public class LoginLEServlet2 extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(correo.equals("pwsamani@cibertec.edu.pe")&& clave.equals("123456789")) {
			...
			request.getRequestDispatcher("principalLE2.jsp").forward(request, response);
		}else {
			request.setAttribute("mensaje", "Error en usuario y/o clave");
			request.getRequestDispatcher("loginLE2").forward(request, response);
		}
	}
